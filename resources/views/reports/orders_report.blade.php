            ...
            <div class="card-header pb-0">
                ...
                <form action="/search_orders" method="POST" role="search" autocomplete="off">
                    ...
                    <div class="col-lg-3 mg-t-20 mg-lg-t-0">
                        <label class="rdiobox"><input name="rdio" value="2" type="radio"><span>بحث برقم الطلب
                            </span></label>
                    </div><br><br>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-3 mg-t-20 mg-lg-t-0" id="type">
                            <p class="mg-b-10">تحديد نوع حالات الطلب</p><select class="form-control select2" name="type"
                                required>
                                <option value="{{ $type ?? 'حدد نوع حالة الدفع' }}" selected>
                                    {{ $type ?? 'حدد نوع حالة الطلب' }}
                                </option>

                                <option value="منفذ">منفذ </option>
                                <option value="غير منفذ">غير منفذ  </option>
                        ...
                        <div class="col-lg-3 mg-t-20 mg-lg-t-0" id="order_number">
                            <p class="mg-b-10">البحث برقم الطلب</p>
                                    ...
                                    <tr>
                                        ...
                                        <div class="dropdown">
                                                ...
                                                <div class="dropdown-menu tx-13">
                                                    ...
                                                    <a class="dropdown-item" href="{{ URL::route('status_show',[$order->id]) }}">
                                                    <i  class="cf cf-zec"></i> &nbsp; حالة الطلب و الدفع</a> 
                                                       
                                                       
                                                    <a class="dropdown-item"    href="{{ url('details_order') }}/{{ $order->id }}">
                                                    <i class="fas fa-eye"></i> &nbsp; تفاصيل الطلب </a> 
