                    ...
                    <div class="myLeftCtn">
                        <form method="POST" action="{{ route('register') }}" class="myForm text-center">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" placeholder="اسم المستخدم" id="name" name="name"
                                    class="myInput input1 @error('name') is-invalid @enderror" value="{{ old('name') }}"
                            ...
                            <div class="form-group">
                                <i class="fas fa-lock"></i>
                                <input id="password-confirm" type="password" class="myInput"
                                    placeholder="تأكيد كلمة السر" name="password_confirmation" required
                                    autocomplete="new-password">
                            </div>
                            <input type="submit" class="butt" value="تسجيل">
