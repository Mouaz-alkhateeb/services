			...
			<div class="main-sidemenu">
				<div class="app-sidebar__user clearfix">
					<div class="dropdown user-pro-body">
						<div class="">
							<img alt="user-img" class="avatar avatar-xl brround" src="{{URL::asset('assets/img/faces/2.jpg')}}"><span class="avatar-status profile-status bg-green"></span>
						</div>
						<div class="user-info">
				...
				<ul class="side-menu">
					...
					<li class="slide">
						...
						<ul class="slide-menu">
							...
							<li><a class="slide-item" href="{{ url('/' . $page='chat') }}">محادثات المستخدمين </a></li>
						</ul>
					</li>
					<li class="slide">
						...
						<ul class="slide-menu">
							<li><a class="slide-item" href="{{ url('/' . $page='orders_report') }}">تقارير الطلبات</a></li>
							<li><a class="slide-item" href="{{ url('/' . $page='profits_report') }}"> تقارير الأرباح</a></li>
							<li><a class="slide-item" href="{{ url('/' . $page='customers_report') }}">تقارير المستخدمين</a></li>
						</ul>
					</li>					
				</ul>
			</div>
